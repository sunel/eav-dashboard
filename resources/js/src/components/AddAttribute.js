...
import { presistAttribute, fetchBackendTypes, fetchFrontendTypes } from '../utils/WebAPI';
...
class AddAttribute extends PureComponent {
    ...
    onSave = async (values) => {
        ...
        try {
            ...
            const response = await presistAttribute({ entity: this.props.entity }, post, {});

            this.props.dispatch(addAttributes({ entity: this.props.entity, data: response }));
            ...
            <Form layout="horizontal" onSubmit={this.handleSubmit}>
                ...
                >
                    {getFieldDecorator('code', {
                        ...
                        <Input placeholder="Code" autoComplete="off" autoFocus />
                    )}
                </Form.Item>
                <Form.Item
                ...
                >
                    {getFieldDecorator('frontend_label', {
                        ...
                        <Input placeholder="Frontend Label" autoComplete="off" />
                    )}
                </Form.Item>
                <Form.Item
                    label="Frontend Type"
...
const WrappedAddAttributeForm = Form.create({ name: 'add_attribute' })(AddAttribute);


export default connect()(WrappedAddAttributeForm);