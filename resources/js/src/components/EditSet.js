...
import { presistExistingSet } from '../utils/WebAPI';
...
class EditSet extends PureComponent {
    ...
    onSave = async (values) => {
        ...
        try {
            ...
            const response = await presistExistingSet({ entity: this.props.entity.entity_code, set: this.props.id }, post, {});

            this.props.updateSet(response, this.props.index);
...
const WrappedEditSetpForm = Form.create({ name: 'add_group' })(EditSet);


export default connect()(WrappedEditSetpForm);